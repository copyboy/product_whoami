...
| M2/WI2 文章「EVM 是什么，为什么重要」 | todo | `src/content/blog/evm-deep-dive.mdx` (output) | WI1 | 词典已有 EVM/PoS |
| M2/WI3 文章「Gas 为什么存在，怎么计算」 | todo | `src/content/blog/ethereum-gas-fees.mdx` (output) | WI2 | 词典已有 Gas/EIP1559 |
