...
Install already replaced `Product Whoami` placeholders. Verify the substitution, then leave alone (or replace `AGENTS.md` with your own contract — many projects do).
...
| `docs/index.md` | WI5 | Verify no `Product Whoami` residue; fill remaining route placeholders. |
