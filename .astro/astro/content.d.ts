...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"blog": {
"account-model-vs-utxo.mdx": {
	id: "account-model-vs-utxo.mdx";
  slug: "account-model-vs-utxo";
  body: string;
  collection: "blog";
...
"deploy-to-testnet.mdx": {
	id: "deploy-to-testnet.mdx";
  slug: "deploy-to-testnet";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".mdx"] };
...
"ethereum-gas-fees.mdx": {
	id: "ethereum-gas-fees.mdx";
...
"solidity-basics-notes.mdx": {
	id: "solidity-basics-notes.mdx";
  slug: "solidity-basics-notes";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".mdx"] };
