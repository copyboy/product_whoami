...
This project is indexed by GitNexus as **product_whoami** (4728 symbols, 4721 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
